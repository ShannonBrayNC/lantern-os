...
def transfer(source_url: str, target_url: str) -> None:
    ...
    print(f"Transferred Lantern OS data from {source.dialect.name} to {target.dialect.name}")


def main() -> None:
    parser = argparse.ArgumentParser(description="Transfer Lantern OS data between SQLAlchemy databases.")
